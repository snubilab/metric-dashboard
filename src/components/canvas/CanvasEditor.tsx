...
export type { Layer } from "./sceneDraw";
...
export function CanvasEditor({
  ...
  useEffect(() => {
    ...
    // Base scene: visible layers' shapes + de-collided GT/A/B tag badges. This
    // is the SAME visual the read-only ShapeCanvas produces. The interactive
    // extras below (selection handles, freehand preview, drag-to-create ghost)
