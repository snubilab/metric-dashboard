...
const KO_METRIC_LABELS: Record<string, string> = {
  ...
  rougeL: "ROUGE-L",
  meteor: "METEOR proxy",
  bertScore: "BERTScore proxy",
  rateScore: "RaTEscore proxy",
  chexbertF1: "CheXbert finding F1 proxy",
  srrBertF1: "SRR-BERT F1 proxy",
  radGraphF1: "RadGraph F1 proxy",
  greenErrors: "GREEN-style error count",
  crimsonWeightedErrors: "CRIMSON-style weighted errors",
  lexicalOverlap: "Lexical overlap proxy",
  findingF1: "Finding F1",
  assertionF1: "Assertion F1",
  lateralityF1: "Laterality F1",
  temporalF1: "Temporal cue F1 proxy",
