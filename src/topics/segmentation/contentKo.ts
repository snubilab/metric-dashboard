...
const sections: MetricSection[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Dice = 2·IoU / (1 + IoU) 관계로 Dice와 연결되어, 두 지표는 예측의 순위를 동일하게 매깁니다.",
    ],
    caveats: [
  ...
  },
  {
    ...
    meaning:
      "표면 Dice는 미리 정한 허용 거리 τ 이내에 있는 표면 점의 비율을 측정합니다. " +
      "허용 오차가 2mm라면, 참조 표면에서 2mm 이내에 있는 경계 점은 허용됩니다.",
    features: [
  ...
  },
  {
    ...
    meaning:
      "부피 차이는 예측한 대상 부피를 정답 부피와 비교합니다. 절대 차이 또는 " +
      "상대(부호 있는) 비율로 보고합니다. MRBrainS 같은 뇌 조직 벤치마크에서 " +
      "쓰이는 부피 일치 지표입니다.",
    features: [
      "모델이 부피를 과소 또는 과대 추정하는지를 직접 측정합니다.",
      "부호 있는 상대 부피 차이는 오차의 방향을 보여줍니다.",
      "조직 부피가 임상적으로 중요할 때 Dice, HD95와 함께 보고됩니다.",
    ],
    caveats: [
  ...
  },
  {
    ...
    meaning:
      ...
      "놓친 작은 병변과 위양성 병변을 드러냅니다. 이것이 BraTS / BraTS-METS의 " +
      "평가 관점입니다.",
    features: [
      "분할을 개별 병변 수준에서 평가합니다.",
      "병변 단위 민감도/정밀도와 함께 TP/FP/FN 병변 개수를 더해 줍니다.",
      "BraTS-METS는 위양성/위음성 병변에 대한 명시적 패널티를 추가합니다.",
    ],
    caveats: [
