...
const sections: MetricSection[] = [
  {
    ...
    meaning:
      ...
      "재는 값입니다. 의료 영상 분할에서 가장 널리 쓰이는 겹침(overlap) 지표입니다.",
    features: [
      "의료 영상 분할에서 가장 널리 쓰입니다.",
      "값의 의미를 직관적으로 이해할 수 있습니다.",
      "이진(binary) 분할과 다중 클래스 분할에 모두 쓸 수 있습니다.",
      "보통 클래스별 Dice나 평균 Dice로 보고합니다.",
    ],
    caveats: [
      "Dice는 영역 겹침을 요약할 뿐, 경계 오차를 직접 재지는 않습니다.",
      "아주 작은 구조에서는 불안정합니다. 몇 픽셀(voxel)만 어긋나도 값이 크게 흔들립니다.",
      "큰 구조에서는 경계 일부가 부정확해도 Dice가 높게 나오곤 합니다.",
    ],
  ...
  },
  {
    ...
    meaning:
      ...
      "일반 컴퓨터 비전과 객체 검출에서 흔히 쓰이고, 검출에서는 박스 겹침을 정의합니다.",
    features: [
      "일반 컴퓨터 비전과 검출에서 박스 겹침을 정의할 때 흔히 씁니다.",
      "Dice와 비슷하지만, 같은 예측이라도 값이 늘 더 낮게 나옵니다.",
  ...
  },
  {
    ...
    meaning:
      "민감도는 실제 대상 영역 가운데 얼마나 검출했는지를 봅니다. " +
      "모델이 놓친 픽셀, 즉 위음성(false negative)에 초점을 둡니다.",
    features: [
      "구조물을 놓치는 비용이 클 때 유용합니다.",
      "작은 병변, 혈관, 선별(screening) 분할 과제에서 특히 중요합니다.",
      "민감도가 높으면 위음성이 적다는 뜻입니다.",
    ],
    caveats: [
      "민감도만 봐서는 위양성(false positive)의 부담을 알 수 없습니다.",
      "과다 분할만으로도 민감도는 부풀려지므로, 정밀도와 함께 읽어야 합니다.",
    ],
  ...
  },
  {
    ...
    meaning:
      "정밀도는 예측한 양성 영역 가운데 실제로 맞은 비율을 봅니다. " +
      "위양성(false positive), 즉 배경으로의 과다 분할에 초점을 둡니다.",
    features: [
      "과다 분할을 점검할 때 유용합니다.",
      "정밀도가 낮으면 위양성 픽셀이나 영역이 많다는 뜻입니다.",
      "정밀도가 높으면 위양성이 적다는 뜻입니다.",
    ],
    caveats: [
      "보수적인 모델은 정밀도는 높아도 민감도가 낮을 수 있습니다.",
      "정밀도와 민감도는 따로 보지 말고 함께 해석합니다.",
    ],
  ...
  },
  {
    ...
    meaning:
      ...
      "예측과 정답 표면 사이의 최악(worst-case) 경계 불일치를 잡아냅니다.",
    features: [
      "최악의 경계 불일치를 잡아냅니다.",
      "큰 국소 경계 오차 하나가 임상적으로 중요할 때 유용합니다.",
    ],
    caveats: [
      "이상치(outlier)에 매우 민감합니다.",
      "멀리 떨어진 위양성 영역 하나만으로도 HD가 크게 치솟을 수 있습니다.",
    ],
    figure: figureFor("hd"),
    complements:
  ...
  },
  {
    ...
    features: [
      ...
      "의료 분할 논문에서 Dice와 함께 자주 보고됩니다.",
      "극단적 이상치의 영향은 줄이면서도 경계 오차는 그대로 잡아냅니다.",
    ],
    caveats: [
  ...
  },
  {
    ...
    features: [
      "최악의 한 점이 아니라 경계 불일치의 평균을 봅니다.",
      "HD보다 극단적인 점 하나에 덜 좌우됩니다.",
      "ASSD는 예측→정답과 정답→예측 거리를 모두 따집니다.",
    ],
    caveats: [
  ...
  },
  {
    ...
    meaning:
      ...
      "(여기서는 단일 2D 슬라이스에서 1 px = 1 mm로 두지만, 실제 임상에서는 mm 단위로 측정되는 3D 표면입니다.)",
    features: [
      "과제별로 허용 오차를 정할 수 있습니다.",
      "작은 경계 편차가 임상적으로 허용되는 상황에서 유용합니다.",
      "원시 HD나 ASSD보다 해석하기 쉬울 때가 많습니다.",
      "여러 의료 벤치마크(Medical Segmentation Decathlon, KiTS23)에서 씁니다.",
    ],
    caveats: [
      "허용 오차 값을 신중하게 골라야 합니다.",
      "허용 오차는 장기, 병변 종류, 영상 양식(modality), 임상 용도에 따라 달라집니다.",
    ],
  ...
  },
  {
    ...
    features: [
      "모델이 부피를 과소 추정하는지 과대 추정하는지를 직접 봅니다.",
      "부호 있는 상대 부피 차이는 오차의 방향을 알려 줍니다.",
  ...
  },
  {
    ...
    meaning:
      ...
      "병변별로 Dice와 HD95를 평가합니다. 그러면 픽셀 평균이 가려버리는 " +
      "놓친 작은 병변과 위양성 병변이 드러납니다. 특히 병변 단위 Dice와 HD95는 " +
      "놓친(FN) 병변과 엉뚱한(FP) 병변에 패널티를 줍니다. 매칭되지 않은 " +
      "병변은 각각 Dice 0과 최악(worst-case) 거리로 계산되어 병변별 평균을 끌어내립니다. " +
      "이것이 BraTS / BraTS-METS의 평가 관점입니다.",
    features: [
      "분할을 개별 병변 단위로 평가합니다.",
      "병변 단위 민감도/정밀도와 함께 TP/FP/FN 병변 개수까지 알려 줍니다.",
      "놓친(FN) 병변과 엉뚱한(FP) 병변은 Dice 0 / 최악 거리로 패널티를 받습니다(BraTS-METS 방식).",
    ],
    caveats: [
      "픽셀 Dice가 높아도 완전히 놓친 작은 병변(낮은 병변 단위 민감도)을 가릴 수 있습니다.",
      "매칭 결과는 선택한 기준(IoU 대 무게중심)과 임계값에 따라 달라집니다.",
    ],
  ...
  },
  {
    ...
    meaning:
      "clDice는 혈관이나 기도처럼 관 모양(tubular) 구조를 위한 지표로, 위상과 연결성까지 " +
      "함께 보는 겹침 지표입니다. 위상 정밀도(예측 중심선이 정답 마스크 안에 있는 정도)와 위상 " +
      "민감도(정답 중심선이 예측 마스크 안에 있는 정도)를 조화 평균하므로, 어떤 혈관은 " +
      "Dice가 높더라도 중심선이 끊겨 있으면 점수가 낮게 나올 수 있습니다.",
    features: [
      "연결성에 민감합니다. 단순한 픽셀 겹침이 아니라 끊기지 않은 중심선에 점수를 줍니다.",
      "혈관, 기도, 신경처럼 관 모양·나무 모양 구조를 겨냥해 설계되었습니다.",
      "위상을 함께 보는 보완 지표라서 Dice와 자연스럽게 짝을 이룹니다.",
    ],
    caveats: [
...
export const segmentationLearnKo: LearnContent = {
  intro:
    ...
    "간, 신장, 종양, 혈관, 뇌 조직 — 에 속하는지를 묻습니다. 그래서 평가할 때는 " +
    "예측 마스크가 정답과 얼마나 겹치는지, 경계가 얼마나 정확한지, 작은 구조를 " +
    "놓치지는 않는지, 모델이 배경까지 과다 분할하지는 않는지를 봅니다. " +
    "Metrics Reloaded를 따라, 아래 지표들은 겹침 기반, 경계·표면 기반, 부피 기반, " +
    "병변 단위 계열로 묶었습니다. 숫자 하나로는 충분하지 않습니다. 계열마다 " +
    "놓치는 실패 양상이 다르기 때문에, 의료 벤치마크는 겹침 지표를 " +
    "경계·표면·부피·병변 단위 지표와 짝지어 보고합니다.",
  sections,
  complementarity: {
    intro:
      "Metrics Reloaded의 핵심 주장은 지표 하나로는 충분하지 않다는 것입니다. " +
      "어떤 지표든 놓치는 실패 양상이 있으므로, 서로의 사각지대를 " +
      "메워 주는 지표를 짝지어 보고해야 합니다. 겹침 지표는 경계·표면·부피·병변 " +
      "단위 지표와 함께 보고하세요.",
    pairs: [
      {
