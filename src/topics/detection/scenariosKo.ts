...
export const detectionScenariosKo: Scenario[] = [
  {
    ...
    clinical: {
      ...
      atStake:
        ...
        "느려지고 경보 피로가 쌓입니다.",
      consequence:
        "받아들일 만한 스캔당 1 FP에서 민감도는 약 0.8이고, 스캔당 4 FP까지 올려도 " +
        "여전히 0.8에 머뭅니다. 미세 결절은 임계값을 아주 낮춰야 비로소 드러나므로, " +
        "민감도를 완전히 채우려면 스캔당 4 FP를 한참 넘긴 약 5.4가 필요합니다. LUNA16 " +
        "점수는 스캔당 FP가 {1/8, 1/4, 1/2, 1, 2, 4, 8}인 일곱 개 예산에 걸쳐 이 " +
        "절충을 평균낸 값입니다.",
    },
    teachingPoint:
      "FROC는 거짓양성 부담을 그대로 보여줍니다. 병변 민감도를 끌어올릴 때마다 " +
      "스캔당 거짓 표시가 늘어나는 대가가 따릅니다. 스캔당 FP를 함께 밝히지 않은 " +
      "민감도 수치 하나만으로는 아무것도 말해주지 못합니다.",
  },
  {
    ...
    teachingPoint:
      "AP50은 높은데 AP75가 낮다면, 객체를 찾기는 해도 위치를 느슨하게 잡는 모델일 " +
      "가능성이 큽니다. 하나만 떼어 인용하지 말고 AP50, AP75, AP@[.5:.95]를 늘 함께 " +
      "보세요.",
  },
  {
    ...
    teachingPoint:
      "영상당 FP를 고정한 민감도는 거짓양성 예산을 똑같이 맞춰 두 검출기를 공정하게 " +
      "비교하게 해줍니다. 다만 그 예산이 임상 워크플로와 맞아야 하고, 영상당 FP를 " +
      "스캔당 FP와 바꿔 써서는 안 됩니다.",
  },
  {
    ...
    teachingPoint:
      "전체 슬라이드 영상에서 FROC 곡선은 영상당 FP를 가로축으로 그립니다. 병변 단위 " +
      "민감도는 병리의가 감당할 영상당 거짓양성 부담을 정한 뒤에야 비로소 뜻이 " +
      "통합니다.",
  },
];
